...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionUpdatePlants() {
        ...
        if (cursor != null && cursor.moveToNext()){
            int createIndex = cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_CREATION_TIME);
            int waterIndex = cursor.getColumnIndex(PlantContract.PlantEntry.COLUMN_LAST_WATERED_TIME);
